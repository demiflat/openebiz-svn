...
import org.openebiz.core.businessdocs.ForwardingInstructionType;
import java.util.Iterator;
import org.hibernate.criterion.Restrictions;
import org.hibernate.criterion.Order;
import org.hibernate.LockMode;

public class ForwardingInstructionTypeDAOImpl extends HibernateDaoSupport implements
		ForwardingInstructionTypeDAO {


	static private final Log log = LogFactory
			.getLog(ForwardingInstructionTypeDAOImpl.class);

	public List getAll() {
		List values = null;
		Session session = getSession();
		Criteria allValues = session
				.createCriteria(ForwardingInstructionType.class);
	...
	public ForwardingInstructionType getById(Long id) {
		ForwardingInstructionType value = null;
		Session session = getSession();
		value = (ForwardingInstructionType) session.load(
				ForwardingInstructionType.class, id);
		return value;
	}
	...
	public void insert(ForwardingInstructionType value) {
		Session session = getSession();
		session.save(value);
	...
	public void update(ForwardingInstructionType value) {
		Session session = getSession();
	...
	public ForwardingInstructionType merge(ForwardingInstructionType value) {
		ForwardingInstructionType newValue = null;
		Session session = getSession();
		newValue = (ForwardingInstructionType) session.merge(value);
		if (log.isDebugEnabled())
			log.debug("merging document: " + value);
		return newValue;
	}

	public void delete(ForwardingInstructionType value) {
		Session session = getSession();
	...
	public void delete(Long id) {
		ForwardingInstructionType value = getById(id);
		Session session = getSession();
		if (value != null) {
			session.refresh(value, LockMode.UPGRADE);
			session.delete(value);
