...
import org.openebiz.core.businessdocs.InvoiceType;
import java.util.Iterator;
import org.hibernate.criterion.Restrictions;
import org.hibernate.criterion.Order;
import org.hibernate.LockMode;

public class InvoiceTypeDAOImpl extends HibernateDaoSupport implements InvoiceTypeDAO {


	static private final Log log = LogFactory.getLog(InvoiceTypeDAOImpl.class);

	public List getAll() {
		List values = null;
		Session session = getSession();
		Criteria allValues = session.createCriteria(InvoiceType.class);
	...
	public InvoiceType getById(Long id) {
		InvoiceType value = null;
		Session session = getSession();
		value = (InvoiceType) session.load(InvoiceType.class, id);
		return value;
	}
	...
	private Criteria getHBCriteria(Session session, SearchCriteria criteria) {
		Criteria newCriteria = session.createCriteria(InvoiceType.class);
	...
	public void insert(InvoiceType value) {
		Session session = getSession();
		session.save(value);
	...
	public void update(InvoiceType value) {
		Session session = getSession();
	...
	public InvoiceType merge(InvoiceType value) {
		InvoiceType newValue = null;
		Session session = getSession();
		newValue = (InvoiceType) session.merge(value);
		if (log.isDebugEnabled())
			log.debug("merging document: " + value);
		return newValue;
	}

	public void delete(InvoiceType value) {
		Session session = getSession();
