...
public class ContactTypeDAOImpl extends HibernateDaoSupport implements ContactTypeDAO {

	
	static private final Log log = LogFactory.getLog(ContactTypeDAOImpl.class);

	public List getAll() {
		List values = null;
		Session session = getSession();
		Criteria allValues = session.createCriteria(ContactType.class);
	...
	public ContactType getById(Long id) {
		ContactType value = null;
		Session session = getSession();
		value = (ContactType) session.load(ContactType.class, id);
		return value;
	}
	...
	private Criteria getHBCriteria(Session session, SearchCriteria criteria) {
		Criteria newCriteria = session.createCriteria(ContactType.class);
	...
	public ContactType merge(ContactType value) {
		...
		Session session = getSession();
		newValue = (ContactType) session.merge(value);
		if (log.isDebugEnabled())
