...
import org.openebiz.core.common.udt.GraphicType;
import java.util.Iterator;
import org.hibernate.criterion.Restrictions;
import org.hibernate.criterion.Order;
import org.hibernate.LockMode;

public class GraphicTypeDAOImpl extends HibernateDaoSupport implements GraphicTypeDAO {

	
	static private final Log log = LogFactory.getLog(GraphicTypeDAOImpl.class);

	public List getAll() {
		List values = null;
		Session session = getSession();
		Criteria allValues = session.createCriteria(GraphicType.class);
	...
	public GraphicType getById(Long id) {
		GraphicType value = null;
		Session session = getSession();
		value = (GraphicType) session.load(GraphicType.class, id);
		return value;
	}
	...
	private Criteria getHBCriteria(Session session, SearchCriteria criteria) {
		Criteria newCriteria = session.createCriteria(GraphicType.class);
	...
	public void insert(GraphicType value) {
		Session session = getSession();
		session.save(value);
	...
	public void update(GraphicType value) {
		Session session = getSession();
	...
	public GraphicType merge(GraphicType value) {
		GraphicType newValue = null;
		Session session = getSession();
		newValue = (GraphicType) session.merge(value);
		if (log.isDebugEnabled())
			log.debug("merging document: " + value);
		return newValue;
	}

	public void delete(GraphicType value) {
		Session session = getSession();
