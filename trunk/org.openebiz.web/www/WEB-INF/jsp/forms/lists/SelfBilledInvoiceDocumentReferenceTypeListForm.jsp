...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="selfBilledInvoiceDocumentReferenceList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addSelfBilledInvoiceDocumentReference" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearSelfBilledInvoiceDocumentReference" value="<fmt:message key="ui.button.clear" />" />
