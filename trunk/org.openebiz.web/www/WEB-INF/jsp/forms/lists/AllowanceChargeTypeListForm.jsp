...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Allowance Charge List</legend>
		<spring:hasBindErrors name="allowanceChargeList">
		...
		<c:if test="${not empty allowanceChargeList}">
			<c:forEach items="${allowanceChargeList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addAllowanceCharge" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearAllowanceCharge" value="<fmt:message key="ui.button.clear" />" />
