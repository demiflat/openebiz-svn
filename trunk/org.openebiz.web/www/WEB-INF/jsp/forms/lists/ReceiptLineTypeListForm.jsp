...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Receipt Line List</legend>
		<spring:hasBindErrors name="receiptLineList">
		...
		<c:if test="${not empty receiptLineList}">
			<c:forEach items="${receiptLineList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addReceiptLine" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearReceiptLine" value="<fmt:message key="ui.button.clear" />" />
