...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="taxCategoryList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addTaxCategory" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearTaxCategory" value="<fmt:message key="ui.button.clear" />" />
