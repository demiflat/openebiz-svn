...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="actualPackageList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addActualPackage" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearActualPackage" value="<fmt:message key="ui.button.clear" />" />
