...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Origin Address List</legend>
		<spring:hasBindErrors name="originAddressList">
		...
		<c:if test="${not empty originAddressList}">
			<c:forEach items="${originAddressList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addOriginAddress" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearOriginAddress" value="<fmt:message key="ui.button.clear" />" />
