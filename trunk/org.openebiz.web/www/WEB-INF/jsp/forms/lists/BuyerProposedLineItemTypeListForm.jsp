...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Buyer Proposed Line Item List</legend>
		<spring:hasBindErrors name="buyerProposedLineItemList">
		...
		<c:if test="${not empty buyerProposedLineItemList}">
			<c:forEach items="${buyerProposedLineItemList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addBuyerProposedLineItem" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearBuyerProposedLineItem" value="<fmt:message key="ui.button.clear" />" />
