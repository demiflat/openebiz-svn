...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="shipmentList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addShipment" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearShipment" value="<fmt:message key="ui.button.clear" />" />
