...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="documentReferenceList">
		...
		<c:if test="${not empty documentReferenceList}">
			<c:forEach items="${documentReferenceList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addDocumentReference" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearDocumentReference" value="<fmt:message key="ui.button.clear" />" />
