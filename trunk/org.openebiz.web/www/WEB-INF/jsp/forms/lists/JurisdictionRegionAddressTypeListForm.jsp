...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="jurisdictionRegionAddressList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addJurisdictionRegionAddress" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearJurisdictionRegionAddress" value="<fmt:message key="ui.button.clear" />" />
