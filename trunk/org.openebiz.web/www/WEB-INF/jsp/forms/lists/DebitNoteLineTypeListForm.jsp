...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Debit Note Line List</legend>
		<spring:hasBindErrors name="debitNoteLineList">
		...
		<c:if test="${not empty debitNoteLineList}">
			<c:forEach items="${debitNoteLineList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addDebitNoteLine" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearDebitNoteLine" value="<fmt:message key="ui.button.clear" />" />
