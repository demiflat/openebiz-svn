...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="categorizesClassificationCategoryList">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addCategorizesClassificationCategory" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearCategorizesClassificationCategory" value="<fmt:message key="ui.button.clear" />" />
