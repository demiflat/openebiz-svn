...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Applicable Tax Category List</legend>
		<spring:hasBindErrors name="applicableTaxCategoryList">
		...
		<c:if test="${not empty applicableTaxCategoryList}">
			<c:forEach items="${applicableTaxCategoryList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addApplicableTaxCategory" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearApplicableTaxCategory" value="<fmt:message key="ui.button.clear" />" />
