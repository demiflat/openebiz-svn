...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Carrier Party List</legend>
		<spring:hasBindErrors name="carrierPartyList">
		...
		<c:if test="${not empty carrierPartyList}">
			<c:forEach items="${carrierPartyList}" var="item" varStatus="status">
			<tr>
				<!-- type specific start -->
				<td class="form_titem">
		...
		<div class="submitButtons">
			...
			<input type="submit" class="button" name="_eventId_addCarrierParty" value="<fmt:message key="ui.button.add" />" />
			<input type="submit" class="button" name="_eventId_clearCarrierParty" value="<fmt:message key="ui.button.clear" />" />
