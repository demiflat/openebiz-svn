...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Tariff Description</legend>
		<spring:hasBindErrors name="tariffDescription">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Tariff Description:</td>
			<td class="form_tdispcol">	
			<spring:bind path="tariffDescription.value">
