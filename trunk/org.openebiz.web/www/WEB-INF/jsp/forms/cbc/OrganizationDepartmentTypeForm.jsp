...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Organization Department</legend>
		<spring:hasBindErrors name="organizationDepartment">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Organization Department:</td>
			<td class="form_tdispcol">	
			<spring:bind path="organizationDepartment.value">
