...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Document Qualifier</legend>
		<spring:hasBindErrors name="documentQualifier">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Document Qualifier:</td>
			<td class="form_tdispcol">	
			<spring:bind path="documentQualifier.value">
