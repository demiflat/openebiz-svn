...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Returnability Indicator</legend>
		<spring:hasBindErrors name="returnabilityIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Returnability Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="returnabilityIndicator.value">
