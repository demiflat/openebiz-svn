...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Sealing Party Type</legend>
		<spring:hasBindErrors name="sealingPartyType">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Sealing Party Type:</td>
			<td class="form_tdispcol">	
			<spring:bind path="sealingPartyType.value">
