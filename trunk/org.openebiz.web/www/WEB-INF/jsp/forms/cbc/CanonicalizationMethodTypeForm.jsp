...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Canonicalization Method</legend>
		<spring:hasBindErrors name="canonicalizationMethod">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Canonicalization Method:</td>
			<td class="form_tdispcol">	
			<spring:bind path="canonicalizationMethod.value">
