...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Total Goods Item Quantity</legend>
		<spring:hasBindErrors name="totalGoodsItemQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Total Goods Item Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="totalGoodsItemQuantity.value">
