...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Data Sending Capability</legend>
		<spring:hasBindErrors name="dataSendingCapability">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Data Sending Capability:</td>
			<td class="form_tdispcol">	
			<spring:bind path="dataSendingCapability.value">
