...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Contract Subdivision</legend>
		<spring:hasBindErrors name="contractSubdivision">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Contract Subdivision:</td>
			<td class="form_tdispcol">	
			<spring:bind path="contractSubdivision.value">
