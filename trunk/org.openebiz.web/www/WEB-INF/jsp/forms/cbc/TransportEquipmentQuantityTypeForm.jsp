...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Transport Equipment Quantity</legend>
		<spring:hasBindErrors name="transportEquipmentQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Transport Equipment Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="transportEquipmentQuantity.value">
