...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Price Change Reason</legend>
		<spring:hasBindErrors name="priceChangeReason">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Price Change Reason:</td>
			<td class="form_tdispcol">	
			<spring:bind path="priceChangeReason.value">
