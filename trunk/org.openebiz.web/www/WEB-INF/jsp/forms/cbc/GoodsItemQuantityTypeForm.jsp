...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Goods Item Quantity</legend>
		<spring:hasBindErrors name="goodsItemQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Goods Item Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="goodsItemQuantity.value">
