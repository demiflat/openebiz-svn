...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Packing Material</legend>
		<spring:hasBindErrors name="packingMaterial">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Packing Material:</td>
			<td class="form_tdispcol">	
			<spring:bind path="packingMaterial.value">
