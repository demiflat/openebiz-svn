...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Placard Notation</legend>
		<spring:hasBindErrors name="placardNotation">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Placard Notation:</td>
			<td class="form_tdispcol">	
			<spring:bind path="placardNotation.value">
