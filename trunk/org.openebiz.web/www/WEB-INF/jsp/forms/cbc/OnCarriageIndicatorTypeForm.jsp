...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>On Carriage Indicator</legend>
		<spring:hasBindErrors name="onCarriageIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">On Carriage Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="onCarriageIndicator.value">
