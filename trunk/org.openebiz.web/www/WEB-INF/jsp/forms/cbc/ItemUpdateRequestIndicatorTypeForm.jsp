...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Item Update Request Indicator</legend>
		<spring:hasBindErrors name="itemUpdateRequestIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Item Update Request Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="itemUpdateRequestIndicator.value">
