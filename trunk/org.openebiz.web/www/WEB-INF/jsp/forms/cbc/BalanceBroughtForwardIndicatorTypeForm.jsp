...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Balance Brought Forward Indicator</legend>
		<spring:hasBindErrors name="balanceBroughtForwardIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Balance Brought Forward Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="balanceBroughtForwardIndicator.value">
