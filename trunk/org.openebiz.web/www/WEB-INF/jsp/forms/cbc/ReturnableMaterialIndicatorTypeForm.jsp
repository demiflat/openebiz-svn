...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Returnable Material Indicator</legend>
		<spring:hasBindErrors name="returnableMaterialIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Returnable Material Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="returnableMaterialIndicator.value">
