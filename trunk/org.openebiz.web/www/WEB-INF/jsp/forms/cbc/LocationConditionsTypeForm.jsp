...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Location Conditions</legend>
		<spring:hasBindErrors name="locationConditions">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Location Conditions:</td>
			<td class="form_tdispcol">	
			<spring:bind path="locationConditions.value">
