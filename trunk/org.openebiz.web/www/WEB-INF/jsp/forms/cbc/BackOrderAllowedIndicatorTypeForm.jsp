...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Back Order Allowed Indicator</legend>
		<spring:hasBindErrors name="backOrderAllowedIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Back Order Allowed Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="backOrderAllowedIndicator.value">
