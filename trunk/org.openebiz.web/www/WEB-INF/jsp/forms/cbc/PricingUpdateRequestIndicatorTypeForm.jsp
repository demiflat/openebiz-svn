...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Pricing Update Request Indicator</legend>
		<spring:hasBindErrors name="pricingUpdateRequestIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Pricing Update Request Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="pricingUpdateRequestIndicator.value">
