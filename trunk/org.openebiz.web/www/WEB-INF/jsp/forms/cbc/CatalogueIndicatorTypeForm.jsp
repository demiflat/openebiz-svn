...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Catalogue Indicator</legend>
		<spring:hasBindErrors name="catalogueIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Catalogue Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="catalogueIndicator.value">
