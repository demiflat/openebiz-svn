...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Registration Nationality</legend>
		<spring:hasBindErrors name="registrationNationality">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Registration Nationality:</td>
			<td class="form_tdispcol">	
			<spring:bind path="registrationNationality.value">
