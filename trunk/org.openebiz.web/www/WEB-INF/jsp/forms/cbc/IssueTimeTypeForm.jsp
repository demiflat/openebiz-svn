...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="issueTime">
		...
		<tr>
			...
			<spring:bind path="issueTime.value">
			...
			<td class="form_tinfocol"><img src="<c:url value="/icons/info.gif"/>" alt="<fmt:message key="ubl.desc.timetype" />" /></td>
		</tr>			
		<!-- form element end -->
		</table>
