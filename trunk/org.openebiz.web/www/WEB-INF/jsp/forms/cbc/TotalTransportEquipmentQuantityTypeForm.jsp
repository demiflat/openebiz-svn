...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Total Transport Equipment Quantity</legend>
		<spring:hasBindErrors name="totalTransportEquipmentQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Total Transport Equipment Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="totalTransportEquipmentQuantity.value">
