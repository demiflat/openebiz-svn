...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Pre Carriage Indicator</legend>
		<spring:hasBindErrors name="preCarriageIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Pre Carriage Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="preCarriageIndicator.value">
