...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Tax Evidence Indicator</legend>
		<spring:hasBindErrors name="taxEvidenceIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Tax Evidence Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="taxEvidenceIndicator.value">
