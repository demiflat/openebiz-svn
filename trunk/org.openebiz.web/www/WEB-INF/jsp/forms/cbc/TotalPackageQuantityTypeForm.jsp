...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Total Package Quantity</legend>
		<spring:hasBindErrors name="totalPackageQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Total Package Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="totalPackageQuantity.value">
