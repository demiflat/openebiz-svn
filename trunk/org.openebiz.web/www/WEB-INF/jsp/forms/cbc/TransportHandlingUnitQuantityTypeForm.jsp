...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Transport Handling Unit Quantity</legend>
		<spring:hasBindErrors name="transportHandlingUnitQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Transport Handling Unit Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="transportHandlingUnitQuantity.value">
