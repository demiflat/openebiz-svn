...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Over Supply Quantity</legend>
		<spring:hasBindErrors name="overSupplyQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Over Supply Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="overSupplyQuantity.value">
