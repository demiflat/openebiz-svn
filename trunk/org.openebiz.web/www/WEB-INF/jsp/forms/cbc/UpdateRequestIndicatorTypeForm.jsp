...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Update Request Indicator</legend>
		<spring:hasBindErrors name="updateRequestIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Update Request Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="updateRequestIndicator.value">
