...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Packages Quantity</legend>
		<spring:hasBindErrors name="packagesQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Packages Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="packagesQuantity.value">
