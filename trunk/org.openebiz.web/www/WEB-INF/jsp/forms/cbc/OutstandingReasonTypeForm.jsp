...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Outstanding Reason</legend>
		<spring:hasBindErrors name="outstandingReason">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Outstanding Reason:</td>
			<td class="form_tdispcol">	
			<spring:bind path="outstandingReason.value">
