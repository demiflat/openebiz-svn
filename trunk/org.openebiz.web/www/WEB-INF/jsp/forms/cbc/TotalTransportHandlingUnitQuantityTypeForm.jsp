...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Total Transport Handling Unit Quantity</legend>
		<spring:hasBindErrors name="totalTransportHandlingUnitQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Total Transport Handling Unit Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="totalTransportHandlingUnitQuantity.value">
