...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Country Subentity</legend>
		<spring:hasBindErrors name="countrySubentity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Country Subentity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="countrySubentity.value">
