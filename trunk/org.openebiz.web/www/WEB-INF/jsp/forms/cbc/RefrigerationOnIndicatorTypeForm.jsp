...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Refrigeration On Indicator</legend>
		<spring:hasBindErrors name="refrigerationOnIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Refrigeration On Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="refrigerationOnIndicator.value">
