...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="latitudeDirectionCode">
		...
		<tr>
			...
			<spring:bind path="latitudeDirectionCode.value">
			...
			<td class="form_tinfocol"><img src="<c:url value="/icons/info.gif"/>" alt="<fmt:message key="ubl.desc.latitudedirectioncodetype" />" /></td>
		</tr>			
		<!-- form element end -->
		</table>
