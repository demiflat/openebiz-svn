...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Trading Restrictions</legend>
		<spring:hasBindErrors name="tradingRestrictions">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Trading Restrictions:</td>
			<td class="form_tdispcol">	
			<spring:bind path="tradingRestrictions.value">
