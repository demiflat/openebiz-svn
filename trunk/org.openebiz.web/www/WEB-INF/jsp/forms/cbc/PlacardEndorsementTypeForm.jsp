...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Placard Endorsement</legend>
		<spring:hasBindErrors name="placardEndorsement">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Placard Endorsement:</td>
			<td class="form_tdispcol">	
			<spring:bind path="placardEndorsement.value">
