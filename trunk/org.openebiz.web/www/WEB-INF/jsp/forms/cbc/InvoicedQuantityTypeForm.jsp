...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Invoiced Quantity</legend>
		<spring:hasBindErrors name="invoicedQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Invoiced Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="invoicedQuantity.value">
