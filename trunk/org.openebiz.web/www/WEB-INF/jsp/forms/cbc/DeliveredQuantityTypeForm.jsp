...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Delivered Quantity</legend>
		<spring:hasBindErrors name="deliveredQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Delivered Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="deliveredQuantity.value">
