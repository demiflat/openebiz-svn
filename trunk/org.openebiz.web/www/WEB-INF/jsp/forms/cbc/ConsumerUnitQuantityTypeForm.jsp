...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Consumer Unit Quantity</legend>
		<spring:hasBindErrors name="consumerUnitQuantity">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Consumer Unit Quantity:</td>
			<td class="form_tdispcol">	
			<spring:bind path="consumerUnitQuantity.value">
