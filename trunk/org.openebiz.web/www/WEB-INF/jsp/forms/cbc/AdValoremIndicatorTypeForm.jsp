...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		<legend>Ad Valorem Indicator</legend>
		<spring:hasBindErrors name="adValoremIndicator">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<table class="form_tbody">
		<!-- form element start -->
		<tr>
			<td class="form_tlabelcol">Ad Valorem Indicator:</td>
			<td class="form_tdispcol">	
			<spring:bind path="adValoremIndicator.value">
