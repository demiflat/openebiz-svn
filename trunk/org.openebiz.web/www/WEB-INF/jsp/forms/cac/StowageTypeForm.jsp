...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:hasBindErrors name="stowage">
			<div class="error"><fmt:message key="error.form.header" /></div>
		</spring:hasBindErrors>
		<spring:nestedPath path="stowage">
		...
		<tr>
			...
			<td class="form_teditcol"><input type="submit" class="button" name="_eventId_editLocationID" value="<fmt:message key="ui.button.edit" />" /></td>
		</tr>							
...
<!-- Location list element start-->
		<tr>
			...
			<td class="form_teditcol"><input type="submit" class="button" name="_eventId_editLocationList" value="<fmt:message key="ui.button.edit" />" /></td>
		</tr>	
