...
<form action="openebiz" method="post" accept-charset="UTF-8">
	...
	<fieldset>
		...
		<spring:nestedPath path="language">
		...
		<tr>
			...
			<td class="form_teditcol"><input type="submit" class="button" name="_eventId_editLocaleCode" value="<fmt:message key="ui.button.edit" />" /></td>
		</tr>			
