 ...
 * @generated
 */
public class LongitudeDirectionCodeType implements Serializable {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final String LIST_ID_EDEFAULT = "Longitude Direction"; //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	protected static final String LIST_NAME_EDEFAULT = "Longitude Direction"; //$NON-NLS-1$
	 ...
	 * @ordered
	 */
	protected static final String LIST_SCHEME_URI_EDEFAULT = "urn:oasis:names:specification:ubl:schema:xsd:LongitudeDirectionCode-1.0"; //$NON-NLS-1$
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LongitudeDirectionCodeType other = (LongitudeDirectionCodeType) obj;
